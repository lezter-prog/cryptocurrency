...
<template>
    <div>
        <div class="min-h-full bg-gray-100">
            ...
            <nav class="fixed top-0 z-50 w-full nav-gradient-color border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div class="px-3 py-3 lg:px-5 lg:pl-3">
                    ...
                    <div class="flex items-center justify-start">
                        ...
                        <img src="/cryptoPng.png" class="h-8 mr-3" alt="Crypto Logo" />
                        <span class="self-center text-sm font-semibold sm:text-lg whitespace-nowrap dark:text-white">Crypto Management</span>
                        </a>
                    </div>
                        ...
                        <div class="flex items-center ml-3">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <!-- <DropdownLink :href="route('profile.edit')"> Profile </DropdownLink> -->
                                        <DropdownLink :href="route('logout')" @click.stop.prevent="localStorage.token=''" method="post" as="button">
                                            Log Out
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
            ...
            <SideBar :isAdmin=checkIfAdmin :activeAdmin=activeAdmin :activeCustomer=activeCustomer :activeCrypto=activeCrypto :activeMyCrypto=activeMyCrypto></SideBar>
