...
import TankTableMyCrypto from '@/Components/TankTableMyCryp.vue';
import TankTableSoldCrypto from '@/Components/TankTableSold.vue';
...
<template>
    <Head title="Crypto Mangement" />

    <AuthenticatedLayout :checkIfAdmin=checkIfAdmin :activeMyCrypto=true>
        <template #header>
            <h3 class="font-semibold text-sm text-gray-800 leading-tight">My Crypto</h3>
        </template>
        <div class="">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 pb-4">
                    <div>
                        <h3 class="font-semibold text-sm text-gray-800 leading-tight">Holdings</h3>
                    </div>
                ...
                <TankTableMyCrypto :tableData="tableData" ></TankTableMyCrypto>
            </div>
        </div>
        <div class="mt-6">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 pb-4">
                    <div>
                        <h3 class="font-semibold text-sm text-gray-800 leading-tight">Sold Holdings</h3>
                    </div>
                    <div class="flex justify-end">
                ...
                <TankTableSoldCrypto :soldTableData="soldTableData" ></TankTableSoldCrypto>
            </div>
        </div>
        ...
        <Modal :show="customerModalShow" closeable >
            <div class="px-6 py-4">
                ...
                <form @submit.prevent="registerCustomer" class="mt-4">
                    <div>
                        <h3 class="font-semibold text-xs text-red-800 leading-tight">* The Default password of customer is 12345678</h3>
                    </div>
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <TextInput
                            ...
                            type="text"
                            class="mt-1 block w-full"
                            v-model="registrationForm.contact_number"
                            required
                            autofocus
