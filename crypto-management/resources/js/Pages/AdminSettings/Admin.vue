        ...
        <div class="">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-3 pb-4">
                    ...
                    <div class="col-span-2 flex justify-end">
                        ...
                        <div class="inline-flex rounded-md shadow-sm" role="group">
                            <button  @click="changePassModalShow = true" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-green-300 border border-gray-200 rounded hover:bg-green-500 hover:text-white focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                ...
                <form class="grid grid-cols-2 gap-4 mb-6" @submit.prevent="form.patch(route('profile.update'))">
                    ...
                    <div class="col-span-2 flex items-right justify-end mt-4">
                ...
                <div class="grid grid-cols-2 pb-4">
                    <div>
                        <h3 class="font-semibold text-sm text-gray-800 leading-tight">List of Admin</h3>
                    </div>
                    <div class="flex justify-end">
                        
                            <button @click="adminModalShow = true" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-green-300 border border-gray-200 rounded-lg hover:bg-green-500 hover:text-white focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
