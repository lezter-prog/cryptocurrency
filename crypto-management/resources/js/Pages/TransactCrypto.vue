 ...
 <AuthenticatedLayout :checkIfAdmin=checkIfAdmin >
        ...
        <div class="grid grid-cols-6 pb-4">
                    ...
                    <div class="col-span-3 flex justify-end">
                        <button  @click ="buyCryptoModalShow=true" type="button" class="px-2 py-0 text-xs ml-4 font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 mr-2">Buy Now</button>
                        <h3 class="font-semibold text-sm text-gray-800 leading-tight mr-2">
                           Current Price: 
                        </h3>
                        <h2 class="font-bold text-sm text-gray-800 leading-tight item-center">€{{ cryptoInfo.current_price.toFixed(2) }}</h2>
