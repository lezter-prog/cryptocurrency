...
class CryptoCurrencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        CryptoCurrency::create([
            'code' => 'btcc',
            'name' => 'Bitcoin Cash',
            'description' => 'Bitcoin Cash (BCH) is an altcoin version of the popular Bitcoin cryptocurrency. Bitcoin Cash is the result of a hard fork in blockchain technology. One of the most significant changes from Bitcoin to Bitcoin Cash is the size of the coin',
        ...
        CryptoCurrency::create([
            'code' => 'Litecoin',
            'name' => 'Litecoin',
            'description' => 'Litecoin (LTC) is a peer-to-peer cryptocurrency that was set up by Charlie Lee (a former Google employee) in 2011. It shares many similarities with bitcoin and is based on bitcoin`s original source code. Litecoin was designed to be used for cheaper transactions, and to be more efficient for everyday use.',
        ...
        CryptoCurrency::create([
            'code' => 'NEM',
            'name' => 'NEM',
            'description' => 'Definition. Net Energy Metering (NEM) is a system that helps customers reduce their dependence on fossil fuels by allowing them to use energy generated from renewable sources, like solar panels or wind turbines, to offset their electricity usage from the grid.',
        ...
        CryptoCurrency::create([
            'code' => 'IOTA',
            'name' => 'IOTA',
            'description' => 'IOTA (MIOTA) is a distributed ledger designed to record and execute transactions between machines and devices in the Internet of Things (IoT) ecosystem. The ledger uses a cryptocurrency called MIOTA to account for transactions in its network.',
        ...
        CryptoCurrency::create([
            'code' => 'Dash',
            'name' => 'Dash',
            'description' => 'Dash (CRYPTO:DASH) is a digital currency that offers fast, cheap payments anywhere in the world. It aims to provide a user-friendly experience and privacy equal to cash. Software developer Evan Duffield launched Dash on Jan. 18, 2014, under its original name of XCoin, which was later changed to Darkcoin.',
